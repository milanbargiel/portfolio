  ...
  return (
    <div className="md:text-lg">
      <div className="mb-12 text-gray-300">
        <h2 className="font-semibold mb-4 text-white">About</h2>I am a web
        developer, designer and product owner living and working in Berlin,
        Germany. Former editorial product owner at&nbsp;
        <Link
