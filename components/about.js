  ...
  return (
    <div className="md:text-lg">
      <div className="mb-12 text-gray-300">
        <h2 className="font-semibold mb-4 text-white">About</h2>Hello, I am
        Milan Bargiel. I work in the design and development of websites and
        digital products. Former editorial product owner at{' '}
        <Link
        ...
        . I am interested in UX design, research and web technologies. Find some
