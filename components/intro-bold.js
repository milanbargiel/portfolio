export default function Intro() {
  return (
    <div class="mx-auto max-w-3xl text-center text-4xl leading-tight pt-12 pb-20 px-3 md:pt-16 md:pb-36 md:px-16">
      ...
      <a
        class="underline underline-offset-4 decoration-1 decoration-gray-700 hover:decoration-2 hover:transition-all hover:duration-150"
