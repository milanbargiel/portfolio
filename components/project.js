    ...
    <a href="#" className="group">
      <article className="px-4 pt-8 pb-4 mb-12 rounded-md bg-apricot md:px-8 md:pb-8 md:pt-10 md:flex">
        <div className="md:flex md:flex-col md:mr-8 md:w-3/5">
          ...
          <h3 className="mb-8 text-2xl leading-tight font-medium underline underline-offset-4 decoration-0 decoration-gray-700 group-hover:decoration-1 group-hover:transition-all group-hover:duration-150 group-hover:decoration-gray-500 md:w-4/5">
            {props.title}
          </h3>
