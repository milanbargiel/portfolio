  ...
  return (
    <a href="#" className="group">
      <article className="px-4 pt-8 pb-4 mb-12 rounded-lg bg-apricot md:px-8 md:pb-8 md:pt-12 md:flex">
        <div className="md:flex md:flex-col md:mr-10 md:w-2/3">
          <ul className="text-xs mb-6 leading-normal md:order-last md:mb-0">
            {roleItems}
          </ul>
          <h3 className="mb-8 text-xl leading-snug font-medium md:w-5/6">
            {props.title}
          </h3>
          <div className="text-sm mb-10">{props.children}</div>
        </div>
        <div className="md:flex md:items-center md:justify-center md:ml-10 md:w-1/3">
          <Image
            className={
              props.imageStyles
                ? props.imageStyles
